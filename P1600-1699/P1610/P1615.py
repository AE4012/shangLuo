"""
P1600-1699.P1610.P1615 的 Docstring
# P1615 西游记公司
...
if __name__ == "__main__":
    stolen_time = list(map(int,input().split(":")))
    stolened_time = list(map(int,input().split(":")))
    n = int(input().strip())
    ans = [(stolened_time[i] - stolen_time[i])*(60**(2-i)) for i in range(3)]
